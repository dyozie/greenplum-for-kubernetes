...
The following sections describe how to deploy a new Greenplum cluster and perform other common cluster administration tasks with {{#include ./product_name.md}}:
